...
return [
    ...
    */
    ...
    | A default configuration using session storage and the Eloquent
    | user provider has been defined for you here.
    |
    ...
    */
    ...
    'providers' => [
        ...
        // Uncomment below if you are using database driver instead of Eloquent
        // 'users' => [
        //     'driver' => 'database',
        //     'table' => 'users',
        // ],
    ...
    */
    ...
    'passwords' => [
        'users' => [
            ...
            'throttle' => 60, // Limit token generation to 1 per minute
        ],
    ],
